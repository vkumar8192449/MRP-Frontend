            ...
            <div class="w-full max-w-screen-xl mx-auto p-4 md:py-8">
                <div class="sm:flex sm:items-center sm:justify-between pt-24">
                    <a href="https://flowbite.com/" class="flex items-center sm:mb-0 space-x-3 rtl:space-x-reverse">
                        <img src={mainlogo} class="h-10" alt="Flowbite Logo" />
                ...
                <span class="block text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2023 <a href="https://flowbite.com/" class="hover:underline">MRP™</a>. All Rights Reserved.</span>
            </div>
        </footer>
